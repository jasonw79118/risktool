...
/* ===== PHASE 23.0.60 COMPLEX COST/LOSS TABLE + EVIDENCE-DRIVEN RISK ITEMS ===== */
...
/* ===== END PHASE 23.0.60 SAVE OVERRIDE ===== */


/* ===== PHASE 23.0.60 WORKSPACE BRIDGE ===== */
document.addEventListener("DOMContentLoaded", () => {
  try { refreshWorkspaceDiagnostics(); } catch (e) { console.error(e); }
});
/* ===== END PHASE 23.0.60 WORKSPACE BRIDGE ===== */

/* ===== PHASE 23.0.60 CHROME EDGE WORKSPACE MODE ===== */
...
/* ===== END PHASE 23.0.60 CHROME EDGE WORKSPACE MODE ===== */


/* ===== PHASE 23.0.60 SESSION RESTORE AFTER LOGIN ===== */
...
/* ===== END PHASE 23.0.60 SESSION RESTORE AFTER LOGIN ===== */

/* ===== PHASE 23.0.60 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */
(function(){
...
/* ===== END PHASE 23.0.60 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */


/* ===== PHASE 23.0.60 WORKSPACE-GATED LISTS + POST-LOGIN RESTORE ===== */
(function(){
  const PHASE = "23.0.60";
...
/* ===== PHASE 23.0.60 DIRECT LOGIN RECONNECT HOOK ===== */
(function(){
  const PHASE = "23.0.60";
...
/* ===== PHASE 23.0.60 DIRECT POST-LOGIN RECONNECT FLOW ===== */
(function(){
  const PHASE = "23.0.60";
  ...
  async function writeSessionState29(reason, extra){
    try {
      ...
      await writable.close();
      return payload;
    } catch(e) { console.error('Phase 23.0.60 session write failed', e); return null; }
  }
...
/* ===== PHASE 23.0.60 SIMPLE POST-LOGIN RESTORE SCREEN ===== */
(function(){
  const PHASE = "23.0.60";
...
/* ===== PHASE 23.0.60 SAVED SCENARIO DELETE HARDENING ===== */
(function(){
  const PHASE = "23.0.60";
...
/* ===== PHASE 23.0.60 AREA ROLLUP + ENTERPRISE RISK REPORT ===== */
(function(){
  const PHASE = "23.0.60";
...
/* ===== PHASE 23.0.60 HUBBARD EXPECTED LOSS + PORTFOLIO AREA RANKING ===== */
(function(){
  const PHASE = "23.0.60";
...
/* ===== PHASE 23.0.60 RESET STABILIZATION GUARD ===== */
(function(){
  const PHASE = "23.0.60";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== PHASE 23.0.60 COLUMN SOURCES + FULL ROW EDITING ===== */
(function(){
  const PHASE = "23.0.60";
  const keyMap = { insurance: 'insuranceId', hardFact: 'hardFactId', mitigation: 'mitigationId', acceptedRisk: 'acceptedRiskId', costLoss: 'costLossId' };
...
/* ===== PHASE 23.0.60 COMPLEX WORKSPACE UI ===== */
(function(){
  const PHASE = "23.0.60";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== END PHASE 23.0.60 COMPLEX WORKSPACE UI ===== */

/* ===== PHASE 23.0.60 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */
(function(){
  const PHASE = "23.0.60";
...
/* ===== END PHASE 23.0.60 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */

/* ===== PHASE 23.0.60 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */
(function(){
  const PHASE = "23.0.60";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
  const qs=(s,r=document)=>r.querySelector(s);
...
/* ===== END PHASE 23.0.60 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */

/* ===== PHASE 23.0.60 NEW COMPONENT CREATE + SIDEBAR CLEANUP ===== */
(function(){
  const PHASE = "23.0.60";
  const qs = (s, r=document) => r.querySelector(s);
  const qsa = (s, r=document) => Array.from(r.querySelectorAll(s));
...
/* ===== END PHASE 23.0.60 NEW COMPONENT CREATE + SIDEBAR CLEANUP ===== */

/* ===== PHASE 23.0.60 COMPONENT BUTTON PLACEMENT + SINGLE/BETA VISUAL ALIGNMENT ===== */
(function(){
  const PHASE = "23.0.60";
  const qs = (s, r=document) => r.querySelector(s);
  const qsa = (s, r=document) => Array.from(r.querySelectorAll(s));
...
/* ===== END PHASE 23.0.60 COMPONENT BUTTON PLACEMENT + SINGLE/BETA VISUAL ALIGNMENT ===== */

/* ===== PHASE 23.0.60 SINGLE/BETA FACT-BASED WORKSPACE ALIGNMENT ===== */
(function(){
