...
/* ===== END PHASE 23.0.49 SAVE OVERRIDE ===== */


/* ===== PHASE 23.0.49 WORKSPACE BRIDGE ===== */
document.addEventListener("DOMContentLoaded", () => {
  try { refreshWorkspaceDiagnostics(); } catch (e) { console.error(e); }
});
/* ===== END PHASE 23.0.49 WORKSPACE BRIDGE ===== */

/* ===== PHASE 23.0.49 CHROME EDGE WORKSPACE MODE ===== */
...
/* ===== END PHASE 23.0.49 CHROME EDGE WORKSPACE MODE ===== */


/* ===== PHASE 23.0.49 SESSION RESTORE AFTER LOGIN ===== */
...
/* ===== END PHASE 23.0.49 SESSION RESTORE AFTER LOGIN ===== */

/* ===== PHASE 23.0.49 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */
(function(){
...
/* ===== END PHASE 23.0.49 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */


/* ===== PHASE 23.0.49 WORKSPACE-GATED LISTS + POST-LOGIN RESTORE ===== */
(function(){
  const PHASE = "23.0.49";
...
/* ===== PHASE 23.0.49 DIRECT LOGIN RECONNECT HOOK ===== */
(function(){
  const PHASE = "23.0.49";
...
/* ===== PHASE 23.0.49 DIRECT POST-LOGIN RECONNECT FLOW ===== */
(function(){
  const PHASE = "23.0.49";
  ...
  async function writeSessionState29(reason, extra){
    try {
      ...
      await writable.close();
      return payload;
    } catch(e) { console.error('Phase 23.0.49 session write failed', e); return null; }
  }
...
/* ===== PHASE 23.0.49 SIMPLE POST-LOGIN RESTORE SCREEN ===== */
(function(){
  const PHASE = "23.0.49";
...
/* ===== PHASE 23.0.49 SAVED SCENARIO DELETE HARDENING ===== */
(function(){
  const PHASE = "23.0.49";
...
/* ===== PHASE 23.0.49 AREA ROLLUP + ENTERPRISE RISK REPORT ===== */
(function(){
  const PHASE = "23.0.49";
...
/* ===== PHASE 23.0.49 HUBBARD EXPECTED LOSS + PORTFOLIO AREA RANKING ===== */
(function(){
  const PHASE = "23.0.49";
...
/* PHASE 23.0.49 DOWNLOAD REBUILD */
document.addEventListener("DOMContentLoaded",function(){var v=document.getElementById("appVersion"); if(v)v.textContent="23.0.49";});
