...
/* ===== PHASE 23.0.57 COMPLEX COST/LOSS TABLE + EVIDENCE-DRIVEN RISK ITEMS ===== */
...
/* ===== END PHASE 23.0.57 SAVE OVERRIDE ===== */


/* ===== PHASE 23.0.57 WORKSPACE BRIDGE ===== */
document.addEventListener("DOMContentLoaded", () => {
  try { refreshWorkspaceDiagnostics(); } catch (e) { console.error(e); }
});
/* ===== END PHASE 23.0.57 WORKSPACE BRIDGE ===== */

/* ===== PHASE 23.0.57 CHROME EDGE WORKSPACE MODE ===== */
...
/* ===== END PHASE 23.0.57 CHROME EDGE WORKSPACE MODE ===== */


/* ===== PHASE 23.0.57 SESSION RESTORE AFTER LOGIN ===== */
...
/* ===== END PHASE 23.0.57 SESSION RESTORE AFTER LOGIN ===== */

/* ===== PHASE 23.0.57 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */
(function(){
...
/* ===== END PHASE 23.0.57 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */


/* ===== PHASE 23.0.57 WORKSPACE-GATED LISTS + POST-LOGIN RESTORE ===== */
(function(){
  const PHASE = "23.0.57";
...
/* ===== PHASE 23.0.57 DIRECT LOGIN RECONNECT HOOK ===== */
(function(){
  const PHASE = "23.0.57";
...
/* ===== PHASE 23.0.57 DIRECT POST-LOGIN RECONNECT FLOW ===== */
(function(){
  const PHASE = "23.0.57";
  ...
  async function writeSessionState29(reason, extra){
    try {
      ...
      await writable.close();
      return payload;
    } catch(e) { console.error('Phase 23.0.57 session write failed', e); return null; }
  }
...
/* ===== PHASE 23.0.57 SIMPLE POST-LOGIN RESTORE SCREEN ===== */
(function(){
  const PHASE = "23.0.57";
...
/* ===== PHASE 23.0.57 SAVED SCENARIO DELETE HARDENING ===== */
(function(){
  const PHASE = "23.0.57";
...
/* ===== PHASE 23.0.57 AREA ROLLUP + ENTERPRISE RISK REPORT ===== */
(function(){
  const PHASE = "23.0.57";
...
/* ===== PHASE 23.0.57 HUBBARD EXPECTED LOSS + PORTFOLIO AREA RANKING ===== */
(function(){
  const PHASE = "23.0.57";
...
/* ===== PHASE 23.0.57 RESET STABILIZATION GUARD ===== */
(function(){
  const PHASE = "23.0.57";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== PHASE 23.0.57 COLUMN SOURCES + FULL ROW EDITING ===== */
(function(){
  const PHASE = "23.0.57";
  const keyMap = { insurance: 'insuranceId', hardFact: 'hardFactId', mitigation: 'mitigationId', acceptedRisk: 'acceptedRiskId', costLoss: 'costLossId' };
...
/* ===== PHASE 23.0.57 COMPLEX WORKSPACE UI ===== */
(function(){
  const PHASE = "23.0.57";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== END PHASE 23.0.57 COMPLEX WORKSPACE UI ===== */

/* ===== PHASE 23.0.57 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */
(function(){
  const PHASE = "23.0.57";
...
/* ===== END PHASE 23.0.57 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */

/* ===== PHASE 23.0.57 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */
(function(){
  const PHASE = "23.0.57";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
  const qs=(s,r=document)=>r.querySelector(s);
...
/* ===== END PHASE 23.0.57 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */

/* ===== PHASE 23.0.57 NEW COMPONENT CREATE + SIDEBAR CLEANUP ===== */
(function(){
  const PHASE = "23.0.57";
  const qs = (s, r=document) => r.querySelector(s);
  const qsa = (s, r=document) => Array.from(r.querySelectorAll(s));
...
/* ===== END PHASE 23.0.57 NEW COMPONENT CREATE + SIDEBAR CLEANUP ===== */
