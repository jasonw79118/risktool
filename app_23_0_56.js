...
/* ===== PHASE 23.0.56 COMPLEX COST/LOSS TABLE + EVIDENCE-DRIVEN RISK ITEMS ===== */
...
/* ===== END PHASE 23.0.56 SAVE OVERRIDE ===== */


/* ===== PHASE 23.0.56 WORKSPACE BRIDGE ===== */
document.addEventListener("DOMContentLoaded", () => {
  try { refreshWorkspaceDiagnostics(); } catch (e) { console.error(e); }
});
/* ===== END PHASE 23.0.56 WORKSPACE BRIDGE ===== */

/* ===== PHASE 23.0.56 CHROME EDGE WORKSPACE MODE ===== */
...
/* ===== END PHASE 23.0.56 CHROME EDGE WORKSPACE MODE ===== */


/* ===== PHASE 23.0.56 SESSION RESTORE AFTER LOGIN ===== */
...
/* ===== END PHASE 23.0.56 SESSION RESTORE AFTER LOGIN ===== */

/* ===== PHASE 23.0.56 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */
(function(){
...
/* ===== END PHASE 23.0.56 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */


/* ===== PHASE 23.0.56 WORKSPACE-GATED LISTS + POST-LOGIN RESTORE ===== */
(function(){
  const PHASE = "23.0.56";
...
/* ===== PHASE 23.0.56 DIRECT LOGIN RECONNECT HOOK ===== */
(function(){
  const PHASE = "23.0.56";
...
/* ===== PHASE 23.0.56 DIRECT POST-LOGIN RECONNECT FLOW ===== */
(function(){
  const PHASE = "23.0.56";
  ...
  async function writeSessionState29(reason, extra){
    try {
      ...
      await writable.close();
      return payload;
    } catch(e) { console.error('Phase 23.0.56 session write failed', e); return null; }
  }
...
/* ===== PHASE 23.0.56 SIMPLE POST-LOGIN RESTORE SCREEN ===== */
(function(){
  const PHASE = "23.0.56";
...
/* ===== PHASE 23.0.56 SAVED SCENARIO DELETE HARDENING ===== */
(function(){
  const PHASE = "23.0.56";
...
/* ===== PHASE 23.0.56 AREA ROLLUP + ENTERPRISE RISK REPORT ===== */
(function(){
  const PHASE = "23.0.56";
...
/* ===== PHASE 23.0.56 HUBBARD EXPECTED LOSS + PORTFOLIO AREA RANKING ===== */
(function(){
  const PHASE = "23.0.56";
...
/* ===== PHASE 23.0.56 RESET STABILIZATION GUARD ===== */
(function(){
  const PHASE = "23.0.56";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== PHASE 23.0.56 COLUMN SOURCES + FULL ROW EDITING ===== */
(function(){
  const PHASE = "23.0.56";
  const keyMap = { insurance: 'insuranceId', hardFact: 'hardFactId', mitigation: 'mitigationId', acceptedRisk: 'acceptedRiskId', costLoss: 'costLossId' };
...
/* ===== PHASE 23.0.56 COMPLEX WORKSPACE UI ===== */
(function(){
  const PHASE = "23.0.56";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== END PHASE 23.0.56 COMPLEX WORKSPACE UI ===== */

/* ===== PHASE 23.0.56 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */
(function(){
  const PHASE = "23.0.56";
...
/* ===== END PHASE 23.0.56 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */

/* ===== PHASE 23.0.56 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */
(function(){
  const PHASE = "23.0.56";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
  const qs=(s,r=document)=>r.querySelector(s);
...
/* ===== END PHASE 23.0.56 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */
