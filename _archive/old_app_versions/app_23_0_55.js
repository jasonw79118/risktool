...
/* ===== PHASE 23.0.55 COMPLEX COST/LOSS TABLE + EVIDENCE-DRIVEN RISK ITEMS ===== */
...
/* ===== END PHASE 23.0.55 SAVE OVERRIDE ===== */


/* ===== PHASE 23.0.55 WORKSPACE BRIDGE ===== */
document.addEventListener("DOMContentLoaded", () => {
  try { refreshWorkspaceDiagnostics(); } catch (e) { console.error(e); }
});
/* ===== END PHASE 23.0.55 WORKSPACE BRIDGE ===== */

/* ===== PHASE 23.0.55 CHROME EDGE WORKSPACE MODE ===== */
...
/* ===== END PHASE 23.0.55 CHROME EDGE WORKSPACE MODE ===== */


/* ===== PHASE 23.0.55 SESSION RESTORE AFTER LOGIN ===== */
...
/* ===== END PHASE 23.0.55 SESSION RESTORE AFTER LOGIN ===== */

/* ===== PHASE 23.0.55 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */
(function(){
...
/* ===== END PHASE 23.0.55 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */


/* ===== PHASE 23.0.55 WORKSPACE-GATED LISTS + POST-LOGIN RESTORE ===== */
(function(){
  const PHASE = "23.0.55";
...
/* ===== PHASE 23.0.55 DIRECT LOGIN RECONNECT HOOK ===== */
(function(){
  const PHASE = "23.0.55";
...
/* ===== PHASE 23.0.55 DIRECT POST-LOGIN RECONNECT FLOW ===== */
(function(){
  const PHASE = "23.0.55";
  ...
  async function writeSessionState29(reason, extra){
    try {
      ...
      await writable.close();
      return payload;
    } catch(e) { console.error('Phase 23.0.55 session write failed', e); return null; }
  }
...
/* ===== PHASE 23.0.55 SIMPLE POST-LOGIN RESTORE SCREEN ===== */
(function(){
  const PHASE = "23.0.55";
...
/* ===== PHASE 23.0.55 SAVED SCENARIO DELETE HARDENING ===== */
(function(){
  const PHASE = "23.0.55";
...
/* ===== PHASE 23.0.55 AREA ROLLUP + ENTERPRISE RISK REPORT ===== */
(function(){
  const PHASE = "23.0.55";
...
/* ===== PHASE 23.0.55 HUBBARD EXPECTED LOSS + PORTFOLIO AREA RANKING ===== */
(function(){
  const PHASE = "23.0.55";
...
/* ===== PHASE 23.0.55 RESET STABILIZATION GUARD ===== */
(function(){
  const PHASE = "23.0.55";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== PHASE 23.0.55 COLUMN SOURCES + FULL ROW EDITING ===== */
(function(){
  const PHASE = "23.0.55";
  const keyMap = { insurance: 'insuranceId', hardFact: 'hardFactId', mitigation: 'mitigationId', acceptedRisk: 'acceptedRiskId', costLoss: 'costLossId' };
...
/* ===== PHASE 23.0.55 COMPLEX WORKSPACE UI ===== */
(function(){
  const PHASE = "23.0.55";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== END PHASE 23.0.55 COMPLEX WORKSPACE UI ===== */

/* ===== PHASE 23.0.55 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */
(function(){
  const PHASE = "23.0.55";
...
/* ===== END PHASE 23.0.55 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */
