...
/* =========================
   PHASE 20.1.08 FIX
   Prevent duplicate insurance rendering
========================= */

function safeRenderInsurance(evalList) {
  if (!evalList || evalList.length === 0) return "";

  if (document.getElementById("insurance-eval-block")) return "";

  return `
    <div id="insurance-eval-block">
      ${safeRenderInsurance(evalList)}
    </div>
  `;
}
