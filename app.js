...
/* ===== PHASE 23.0.64 COMPLEX COST/LOSS TABLE + EVIDENCE-DRIVEN RISK ITEMS ===== */
...
/* ===== END PHASE 23.0.64 SAVE OVERRIDE ===== */


/* ===== PHASE 23.0.64 WORKSPACE BRIDGE ===== */
document.addEventListener("DOMContentLoaded", () => {
  try { refreshWorkspaceDiagnostics(); } catch (e) { console.error(e); }
});
/* ===== END PHASE 23.0.64 WORKSPACE BRIDGE ===== */

/* ===== PHASE 23.0.64 CHROME EDGE WORKSPACE MODE ===== */
...
/* ===== END PHASE 23.0.64 CHROME EDGE WORKSPACE MODE ===== */


/* ===== PHASE 23.0.64 SESSION RESTORE AFTER LOGIN ===== */
...
/* ===== END PHASE 23.0.64 SESSION RESTORE AFTER LOGIN ===== */

/* ===== PHASE 23.0.64 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */
(function(){
...
/* ===== END PHASE 23.0.64 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */


/* ===== PHASE 23.0.64 WORKSPACE-GATED LISTS + POST-LOGIN RESTORE ===== */
(function(){
  const PHASE = "23.0.64";
...
/* ===== PHASE 23.0.64 DIRECT LOGIN RECONNECT HOOK ===== */
(function(){
  const PHASE = "23.0.64";
...
/* ===== PHASE 23.0.64 DIRECT POST-LOGIN RECONNECT FLOW ===== */
(function(){
  const PHASE = "23.0.64";
  ...
  async function writeSessionState29(reason, extra){
    try {
      ...
      await writable.close();
      return payload;
    } catch(e) { console.error('Phase 23.0.64 session write failed', e); return null; }
  }
...
/* ===== PHASE 23.0.64 SIMPLE POST-LOGIN RESTORE SCREEN ===== */
(function(){
  const PHASE = "23.0.64";
...
/* ===== PHASE 23.0.64 SAVED SCENARIO DELETE HARDENING ===== */
(function(){
  const PHASE = "23.0.64";
...
/* ===== PHASE 23.0.64 AREA ROLLUP + ENTERPRISE RISK REPORT ===== */
(function(){
  const PHASE = "23.0.64";
...
/* ===== PHASE 23.0.64 HUBBARD EXPECTED LOSS + PORTFOLIO AREA RANKING ===== */
(function(){
  const PHASE = "23.0.64";
...
/* ===== PHASE 23.0.64 RESET STABILIZATION GUARD ===== */
(function(){
  const PHASE = "23.0.64";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== PHASE 23.0.64 COLUMN SOURCES + FULL ROW EDITING ===== */
(function(){
  const PHASE = "23.0.64";
  const keyMap = { insurance: 'insuranceId', hardFact: 'hardFactId', mitigation: 'mitigationId', acceptedRisk: 'acceptedRiskId', costLoss: 'costLossId' };
...
/* ===== PHASE 23.0.64 COMPLEX WORKSPACE UI ===== */
(function(){
  const PHASE = "23.0.64";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== END PHASE 23.0.64 COMPLEX WORKSPACE UI ===== */

/* ===== PHASE 23.0.64 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */
(function(){
  const PHASE = "23.0.64";
...
/* ===== END PHASE 23.0.64 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */

/* ===== PHASE 23.0.64 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */
(function(){
  const PHASE = "23.0.64";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
  const qs=(s,r=document)=>r.querySelector(s);
...
/* ===== END PHASE 23.0.64 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */

/* ===== PHASE 23.0.64 NEW COMPONENT CREATE + SIDEBAR CLEANUP ===== */
(function(){
  const PHASE = "23.0.64";
  const qs = (s, r=document) => r.querySelector(s);
  const qsa = (s, r=document) => Array.from(r.querySelectorAll(s));
...
/* ===== END PHASE 23.0.64 NEW COMPONENT CREATE + SIDEBAR CLEANUP ===== */

/* ===== PHASE 23.0.64 COMPONENT BUTTON PLACEMENT + SINGLE/BETA VISUAL ALIGNMENT ===== */
(function(){
  const PHASE = "23.0.64";
  const qs = (s, r=document) => r.querySelector(s);
  const qsa = (s, r=document) => Array.from(r.querySelectorAll(s));
...
/* ===== END PHASE 23.0.64 COMPONENT BUTTON PLACEMENT + SINGLE/BETA VISUAL ALIGNMENT ===== */

/* ===== PHASE 23.0.64 SINGLE/BETA FACT-BASED WORKSPACE ALIGNMENT ===== */
(function(){
...
/* ===== PHASE 23.0.64 CATEGORY + TAB CLEANUP PATCH ===== */
(function(){
  const PHASE='23.0.64';
...
/* ===== END PHASE 23.0.64 CATEGORY + TAB CLEANUP PATCH ===== */

/* ===== PHASE 23.0.64 REGRESSION FIX: NAV ACTIVE, CATEGORY SELECTS, SINGLE/BETA TAB PANELS ===== */
(function(){
  const PHASE='23.0.64';
...
/* ===== END PHASE 23.0.64 REGRESSION FIX ===== */

/* ===== PHASE 23.0.64 CATEGORY FIELD + WORKSPACE TAB FINALIZATION ===== */
(function(){
  const PHASE='23.0.64';
  const TABS=['1. Scenario Entry','2. Costs / Losses','3. Hard Facts / Evidence','4. Mitigation / Controls','5. Insurance / Risk Transfer','6. Accepted Risk'];
...
/* ===== PHASE 23.0.64 ROUTING + EDITABILITY STABILIZATION PATCH ===== */
(function(){
  const PHASE='23.0.64';
