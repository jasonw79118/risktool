...
/* ===== PHASE 24.0.07 COMPLEX COST/LOSS TABLE + EVIDENCE-DRIVEN RISK ITEMS ===== */
...
/* ===== END PHASE 24.0.07 SAVE OVERRIDE ===== */


/* ===== PHASE 24.0.07 WORKSPACE BRIDGE ===== */
document.addEventListener("DOMContentLoaded", () => {
  try { refreshWorkspaceDiagnostics(); } catch (e) { console.error(e); }
});
/* ===== END PHASE 24.0.07 WORKSPACE BRIDGE ===== */

/* ===== PHASE 24.0.07 CHROME EDGE WORKSPACE MODE ===== */
...
/* ===== END PHASE 24.0.07 CHROME EDGE WORKSPACE MODE ===== */


/* ===== PHASE 24.0.07 SESSION RESTORE AFTER LOGIN ===== */
...
/* ===== END PHASE 24.0.07 SESSION RESTORE AFTER LOGIN ===== */

/* ===== PHASE 24.0.07 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */
(function(){
...
/* ===== END PHASE 24.0.07 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */


/* ===== PHASE 24.0.07 WORKSPACE-GATED LISTS + POST-LOGIN RESTORE ===== */
(function(){
  const PHASE = "24.0.07";
...
/* ===== PHASE 24.0.07 DIRECT LOGIN RECONNECT HOOK ===== */
(function(){
  const PHASE = "24.0.07";
...
/* ===== PHASE 24.0.07 DIRECT POST-LOGIN RECONNECT FLOW ===== */
(function(){
  const PHASE = "24.0.07";
  ...
  async function writeSessionState29(reason, extra){
    try {
      ...
      await writable.close();
      return payload;
    } catch(e) { console.error('Phase 24.0.07 session write failed', e); return null; }
  }
...
/* ===== PHASE 24.0.07 RUNTIME REBASE: LOGIN + EDITABILITY + VIEW GUARD ===== */
(function(){
  'use strict';
  var PHASE='24.0.07';
...
/* ===== END PHASE 24.0.07 RUNTIME REBASE ===== */
/* ===== PHASE 24.0.07 COMPLEX WORKSPACE UI ===== */
(function(){
  const PHASE = "24.0.07";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== END PHASE 24.0.07 COMPLEX WORKSPACE UI ===== */

/* ===== PHASE 24.0.07 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */
(function(){
  const PHASE = "24.0.07";
...
/* ===== END PHASE 24.0.07 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */

/* ===== PHASE 24.0.07 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */
(function(){
  const PHASE = "24.0.07";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
  const qs=(s,r=document)=>r.querySelector(s);
...
/* ===== END PHASE 24.0.07 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */


/* ===== PHASE 24.0.07 SINGLE + BETA WORKSPACE UI RESTORE ===== */
(function(){
  const PHASE='24.0.07';
  const qs=(s,r=document)=>r.querySelector(s); const qsa=(s,r=document)=>Array.from(r.querySelectorAll(s));
  const esc=v=>String(v??'').replace(/[&<>\"]/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;'}[c]));
...
/* ===== END PHASE 24.0.07 SINGLE + BETA WORKSPACE UI RESTORE ===== */


/* ===== PHASE 24.0.07 COMPLEX TEST + NEW COMPONENT ACTIONS ===== */
(function(){
  'use strict';
  const PHASE='24.0.07';
  const qs=(s,r=document)=>r.querySelector(s);
...
/* ===== END PHASE 24.0.07 COMPLEX TEST + NEW COMPONENT ACTIONS ===== */


/* ===== PHASE 24.0.07 BUTTON PLACEMENT + POST-LOGIN WORKSPACE RESTORE ===== */
(function(){
  const VERSION='24.0.07';
  const qs=(s,r=document)=>r.querySelector(s);
  function setVersion(){
...
/* ===== END PHASE 24.0.07 BUTTON PLACEMENT + POST-LOGIN WORKSPACE RESTORE ===== */


/* ===== PHASE 24.0.07 STABILIZATION PATCH ===== */
(function(){
  'use strict';
  const VERSION='24.0.07';
  const qs=(s,r=document)=>r.querySelector(s);
  ...
  function call(name,...args){try{if(typeof window[name]==='function')return window[name](...args)}catch(e){console.warn('RT 24.0.07',name,e)}}
...
/* ===== END PHASE 24.0.07 STABILIZATION PATCH ===== */


/* ===== PHASE 24.0.07 TARGETED FIX: POST-LOGIN LOAD + PORTFOLIO RUNNER ===== */
(function(){
  'use strict';
  const VERSION='24.0.07';
...
/* ===== END PHASE 24.0.07 TARGETED FIX ===== */

/* ===== PHASE 24.0.07 TARGETED LOAD + PORTFOLIO REPORT REBUILD ===== */
(function(){
  'use strict';
  const VERSION='24.0.07';
...
/* ===== END PHASE 24.0.07 TARGETED LOAD + PORTFOLIO REPORT REBUILD ===== */


/* ===== PHASE 24.0.07 TARGETED POST-LOGIN LOAD + PORTFOLIO ACTION BUTTONS ===== */
(function(){
'use strict';
const VERSION='24.0.07', $=(s,r=document)=>r.querySelector(s), $$=(s,r=document)=>Array.from(r.querySelectorAll(s));
const esc=v=>String(v??'').replace(/[&<>"']/g,c=>({'&':'&amp;','<':'&lt;','>':'&gt;','"':'&quot;',"'":'&#39;'}[c]));
...
/* ===== PHASE 24.0.07 PORTFOLIO TOTALS + VERSION LOCK ===== */
(function(){
  'use strict';
  const VERSION = '24.0.07';
  const SCENARIO_KEY = 'risk_manager_saved_evaluations_v2';
  ...
  function renderPortfolioReport(){
    ...
    try { console.log('RiskTool 24.0.07 Portfolio Totals', { totalExposure: totals.exposure, residualRisk: totals.residual, insuranceImpact: totals.insurance, scenarioCount: rows.length }); } catch(e) {}
  }
...
/* ===== END PHASE 24.0.07 PORTFOLIO TOTALS + VERSION LOCK ===== */


/* ===== PHASE 24.0.07 TEST MODE + MODEL VALIDATION SHELL ===== */
(function(){
  const VERSION = '24.0.07';
...
/* ===== END PHASE 24.0.07 TEST MODE + MODEL VALIDATION SHELL ===== */


/* ===== PHASE 24.0.07 SAVE + DASHBOARD REPORT STABILIZATION =====
...
(function(){
  ...
  async function optionallyWriteWorkspaceCopy2404(scenario){
    ...
    } catch(e) { console.warn('24.0.07 workspace copy skipped:', e); }
  }
...
/* ===== END PHASE 24.0.07 SAVE + DASHBOARD REPORT STABILIZATION ===== */


/* ===== PHASE 24.0.07 FIX PACK =====
...
/* ===== END PHASE 24.0.07 FIX PACK ===== */


/* ===== PHASE 24.0.07 STABILIZATION AUDIT PATCH =====
   Scope: repair core broken behavior only. No enhancements.
   Fixes:
   1) One runtime version: 24.0.07.
...
/* ===== END PHASE 24.0.07 STABILIZATION AUDIT PATCH ===== */


/* ===== PHASE 24.0.07 SAVE SYSTEM HARD RESET =====
   ...
   4) Version display is locked to 24.0.07.
*/
(function(){
  'use strict';
  const VERSION = '24.0.07';
...
/* ===== END PHASE 24.0.07 SAVE SYSTEM HARD RESET ===== */
