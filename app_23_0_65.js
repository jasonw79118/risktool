...
/* ===== PHASE 23.0.65 COMPLEX COST/LOSS TABLE + EVIDENCE-DRIVEN RISK ITEMS ===== */
...
/* ===== END PHASE 23.0.65 SAVE OVERRIDE ===== */


/* ===== PHASE 23.0.65 WORKSPACE BRIDGE ===== */
document.addEventListener("DOMContentLoaded", () => {
  try { refreshWorkspaceDiagnostics(); } catch (e) { console.error(e); }
});
/* ===== END PHASE 23.0.65 WORKSPACE BRIDGE ===== */

/* ===== PHASE 23.0.65 CHROME EDGE WORKSPACE MODE ===== */
...
/* ===== END PHASE 23.0.65 CHROME EDGE WORKSPACE MODE ===== */


/* ===== PHASE 23.0.65 SESSION RESTORE AFTER LOGIN ===== */
...
/* ===== END PHASE 23.0.65 SESSION RESTORE AFTER LOGIN ===== */

/* ===== PHASE 23.0.65 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */
(function(){
...
/* ===== END PHASE 23.0.65 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */


/* ===== PHASE 23.0.65 WORKSPACE-GATED LISTS + POST-LOGIN RESTORE ===== */
(function(){
  const PHASE = "23.0.65";
...
/* ===== PHASE 23.0.65 DIRECT LOGIN RECONNECT HOOK ===== */
(function(){
  const PHASE = "23.0.65";
...
/* ===== PHASE 23.0.65 DIRECT POST-LOGIN RECONNECT FLOW ===== */
(function(){
  const PHASE = "23.0.65";
  ...
  async function writeSessionState29(reason, extra){
    try {
      ...
      await writable.close();
      return payload;
    } catch(e) { console.error('Phase 23.0.65 session write failed', e); return null; }
  }
...
/* ===== PHASE 23.0.65 SIMPLE POST-LOGIN RESTORE SCREEN ===== */
(function(){
  const PHASE = "23.0.65";
...
/* ===== PHASE 23.0.65 SAVED SCENARIO DELETE HARDENING ===== */
(function(){
  const PHASE = "23.0.65";
...
/* ===== PHASE 23.0.65 AREA ROLLUP + ENTERPRISE RISK REPORT ===== */
(function(){
  const PHASE = "23.0.65";
...
/* ===== PHASE 23.0.65 HUBBARD EXPECTED LOSS + PORTFOLIO AREA RANKING ===== */
(function(){
  const PHASE = "23.0.65";
...
/* ===== PHASE 23.0.65 RESET STABILIZATION GUARD ===== */
(function(){
  const PHASE = "23.0.65";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== PHASE 23.0.65 COLUMN SOURCES + FULL ROW EDITING ===== */
(function(){
  const PHASE = "23.0.65";
  const keyMap = { insurance: 'insuranceId', hardFact: 'hardFactId', mitigation: 'mitigationId', acceptedRisk: 'acceptedRiskId', costLoss: 'costLossId' };
...
/* ===== PHASE 23.0.65 COMPLEX WORKSPACE UI ===== */
(function(){
  const PHASE = "23.0.65";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== END PHASE 23.0.65 COMPLEX WORKSPACE UI ===== */

/* ===== PHASE 23.0.65 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */
(function(){
  const PHASE = "23.0.65";
...
/* ===== END PHASE 23.0.65 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */

/* ===== PHASE 23.0.65 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */
(function(){
  const PHASE = "23.0.65";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
  const qs=(s,r=document)=>r.querySelector(s);
...
/* ===== END PHASE 23.0.65 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */

/* ===== PHASE 23.0.65 NEW COMPONENT CREATE + SIDEBAR CLEANUP ===== */
(function(){
  const PHASE = "23.0.65";
  const qs = (s, r=document) => r.querySelector(s);
  const qsa = (s, r=document) => Array.from(r.querySelectorAll(s));
...
/* ===== END PHASE 23.0.65 NEW COMPONENT CREATE + SIDEBAR CLEANUP ===== */

/* ===== PHASE 23.0.65 COMPONENT BUTTON PLACEMENT + SINGLE/BETA VISUAL ALIGNMENT ===== */
(function(){
  const PHASE = "23.0.65";
  const qs = (s, r=document) => r.querySelector(s);
  const qsa = (s, r=document) => Array.from(r.querySelectorAll(s));
...
/* ===== END PHASE 23.0.65 COMPONENT BUTTON PLACEMENT + SINGLE/BETA VISUAL ALIGNMENT ===== */

/* ===== PHASE 23.0.65 SINGLE/BETA FACT-BASED WORKSPACE ALIGNMENT ===== */
(function(){
...
/* ===== PHASE 23.0.65 CATEGORY + TAB CLEANUP PATCH ===== */
(function(){
  const PHASE='23.0.65';
...
/* ===== END PHASE 23.0.65 CATEGORY + TAB CLEANUP PATCH ===== */

/* ===== PHASE 23.0.65 REGRESSION FIX: NAV ACTIVE, CATEGORY SELECTS, SINGLE/BETA TAB PANELS ===== */
(function(){
  const PHASE='23.0.65';
...
/* ===== END PHASE 23.0.65 REGRESSION FIX ===== */

/* ===== PHASE 23.0.65 CATEGORY FIELD + WORKSPACE TAB FINALIZATION ===== */
(function(){
  const PHASE='23.0.65';
  const TABS=['1. Scenario Entry','2. Costs / Losses','3. Hard Facts / Evidence','4. Mitigation / Controls','5. Insurance / Risk Transfer','6. Accepted Risk'];
...
/* ===== PHASE 23.0.65 ROUTING + EDITABILITY STABILIZATION PATCH ===== */
(function(){
  const PHASE='23.0.65';
...
/* ===== PHASE 23.0.65 RUNTIME STABILITY FIX ===== */
(function(){
  const PHASE = '23.0.65';
...
/* ===== END PHASE 23.0.65 RUNTIME STABILITY FIX ===== */
