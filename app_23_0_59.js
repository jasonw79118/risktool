...
/* ===== PHASE 23.0.59 COMPLEX COST/LOSS TABLE + EVIDENCE-DRIVEN RISK ITEMS ===== */
...
/* ===== END PHASE 23.0.59 SAVE OVERRIDE ===== */


/* ===== PHASE 23.0.59 WORKSPACE BRIDGE ===== */
document.addEventListener("DOMContentLoaded", () => {
  try { refreshWorkspaceDiagnostics(); } catch (e) { console.error(e); }
});
/* ===== END PHASE 23.0.59 WORKSPACE BRIDGE ===== */

/* ===== PHASE 23.0.59 CHROME EDGE WORKSPACE MODE ===== */
...
/* ===== END PHASE 23.0.59 CHROME EDGE WORKSPACE MODE ===== */


/* ===== PHASE 23.0.59 SESSION RESTORE AFTER LOGIN ===== */
...
/* ===== END PHASE 23.0.59 SESSION RESTORE AFTER LOGIN ===== */

/* ===== PHASE 23.0.59 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */
(function(){
...
/* ===== END PHASE 23.0.59 LOGIN RECONNECT + RESTORE PROMPT FIX ===== */


/* ===== PHASE 23.0.59 WORKSPACE-GATED LISTS + POST-LOGIN RESTORE ===== */
(function(){
  const PHASE = "23.0.59";
...
/* ===== PHASE 23.0.59 DIRECT LOGIN RECONNECT HOOK ===== */
(function(){
  const PHASE = "23.0.59";
...
/* ===== PHASE 23.0.59 DIRECT POST-LOGIN RECONNECT FLOW ===== */
(function(){
  const PHASE = "23.0.59";
  ...
  async function writeSessionState29(reason, extra){
    try {
      ...
      await writable.close();
      return payload;
    } catch(e) { console.error('Phase 23.0.59 session write failed', e); return null; }
  }
...
/* ===== PHASE 23.0.59 SIMPLE POST-LOGIN RESTORE SCREEN ===== */
(function(){
  const PHASE = "23.0.59";
...
/* ===== PHASE 23.0.59 SAVED SCENARIO DELETE HARDENING ===== */
(function(){
  const PHASE = "23.0.59";
...
/* ===== PHASE 23.0.59 AREA ROLLUP + ENTERPRISE RISK REPORT ===== */
(function(){
  const PHASE = "23.0.59";
...
/* ===== PHASE 23.0.59 HUBBARD EXPECTED LOSS + PORTFOLIO AREA RANKING ===== */
(function(){
  const PHASE = "23.0.59";
...
/* ===== PHASE 23.0.59 RESET STABILIZATION GUARD ===== */
(function(){
  const PHASE = "23.0.59";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== PHASE 23.0.59 COLUMN SOURCES + FULL ROW EDITING ===== */
(function(){
  const PHASE = "23.0.59";
  const keyMap = { insurance: 'insuranceId', hardFact: 'hardFactId', mitigation: 'mitigationId', acceptedRisk: 'acceptedRiskId', costLoss: 'costLossId' };
...
/* ===== PHASE 23.0.59 COMPLEX WORKSPACE UI ===== */
(function(){
  const PHASE = "23.0.59";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
...
/* ===== END PHASE 23.0.59 COMPLEX WORKSPACE UI ===== */

/* ===== PHASE 23.0.59 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */
(function(){
  const PHASE = "23.0.59";
...
/* ===== END PHASE 23.0.59 COMPLEX WORKSPACE VISUAL MATCH PATCH ===== */

/* ===== PHASE 23.0.59 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */
(function(){
  const PHASE = "23.0.59";
  try { window.RISKTOOL_RUNTIME_VERSION = PHASE; } catch(e) {}
  const qs=(s,r=document)=>r.querySelector(s);
...
/* ===== END PHASE 23.0.59 COMPLEX WORKSPACE LAYOUT CORRECTION ===== */

/* ===== PHASE 23.0.59 NEW COMPONENT CREATE + SIDEBAR CLEANUP ===== */
(function(){
  const PHASE = "23.0.59";
  const qs = (s, r=document) => r.querySelector(s);
  const qsa = (s, r=document) => Array.from(r.querySelectorAll(s));
...
/* ===== END PHASE 23.0.59 NEW COMPONENT CREATE + SIDEBAR CLEANUP ===== */

/* ===== PHASE 23.0.59 COMPONENT BUTTON PLACEMENT + SINGLE/BETA VISUAL ALIGNMENT ===== */
(function(){
  const PHASE = "23.0.59";
  const qs = (s, r=document) => r.querySelector(s);
  const qsa = (s, r=document) => Array.from(r.querySelectorAll(s));
...
/* ===== END PHASE 23.0.59 COMPONENT BUTTON PLACEMENT + SINGLE/BETA VISUAL ALIGNMENT ===== */

/* ===== PHASE 23.0.59 SINGLE/BETA FACT-BASED WORKSPACE ALIGNMENT ===== */
(function(){
